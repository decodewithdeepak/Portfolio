...
export function EducationCard({ degree, institution, period, score }: EducationCardProps) {
  return (
    <div className="group relative bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
